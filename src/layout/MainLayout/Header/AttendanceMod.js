...
const AttendanceMod = () => {
  ...
  const handleCheckInClick = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://pulsehr-express-server.onrender.com/clock/create', checkInData);
  ...
  const handleBreakClick = async () => {
    if (breakButtonLabel === 'Break') {
      const currentDate = new Date();
      try {
        const response = await axios.post(`https://pulsehr-express-server.onrender.com/break/create`, {
      ...
      const currentDate = new Date();
      try {
        const response = await axios.put(`https://pulsehr-express-server.onrender.com/break/update/${breakinID}`, {
  ...
  const getdata = async () => {
    try {
      ...
      const resp = await axios.get(`https://pulsehr-express-server.onrender.com/api/getemployee/${employee._id}`);
  ...
  const handleCheckOutClick = async () => {
    ...
    try {
      const response = await axios.put(`https://pulsehr-express-server.onrender.com/clock/update/${parclock._id}`, {
