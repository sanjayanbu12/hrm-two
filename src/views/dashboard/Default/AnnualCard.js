                                ...
                                <Grid item>
                                    <Grid container justifyContent="space-between">
                                       <div style={{display:'flex',justifyContent:'space-between',}}>
                                            ...
                                            <Button onClick={() => setopen(true)} sx={{padding:'0px'}}>Add</Button>
                                            </div>
                                    ...
                                    <Grid container alignItems="center">
                                        <Grid item xs={6}>
                                            <Grid container alignItems="center">
                                                <Grid item>
                                                    {(
                                                        <Typography sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0 }}>{employeeleave ? employeeleave : ''}</Typography>
                                                    )}
                                                </Grid>
                                                <Grid item xs={12}>
                                                    <Typography
