...
const LandingPageSeven = () => {
  ...
  const memoizedPlaylistItems = useMemo(
    () => [
      {
        movieUrl: 'https://assets.asana.biz/m/4192d4d360b06ca4/original/LP_PAC_Carousel01_Video01_List_ENUS.mp4',
        moviePoster: ''
      },
      {
        movieUrl: 'https://assets.asana.biz/m/31e5cd8090cd4568/original/LP_PAC_Carousel01_Video02_Board_ENUS.mp4'
      },
      {
        movieUrl: 'https://assets.asana.biz/m/24ff3cebe30cfeae/original/LP_PAC_Carousel01_Video03_Timeline_ENUS.mp4'
      }
    ],
    []
  );
      ...
      <SecondContainers>
        <Container style={{ paddingLeft: '0px', paddingRight: '0px' }}>
          <Grid className="fourth-page" container alignItems={'center'}>
            ...
            >
              <Grid item lg={10}>
                <List id="playlist" style={{ display: 'flex', flexDirection: 'column', marginBottom: '30px', padding: '0px 0px 16px 0px' }}>
                  <Accordion
