...
const PopupSubGoal = ({ onClose, reloadGoals, Id }) => {
  ...
  const handleSubmit = async () => {
    try {
      if (GoalTit && GoalPer && GoalType && GoalWhy && GoalDes) {
        const response = await axios.post(`https://hrm-backend-square.onrender.com/goal/addgoal/${Id}`, {
          _id: Id,
          GoalT: GoalTit,
          GoalP: GoalPer,
          GoalTyp: GoalType,
        ...
        console.log('Sub Goal added:', response.data);
